...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    description: 'Explicá cómo se organizan el estado local, Supabase, filtros, caché y actualización de la interfaz.',
    level: 'Intermedio',
    status: 'Disponible',
    progress: 15,
  },
  {
    slug: 'monedero-testing',
    section: 'Monedero',
    title: 'Testing y calidad financiera',
    description: 'Prepará una estrategia de pruebas para balances, transacciones, autenticación y regresiones.',
    level: 'Intermedio',
    status: 'Próximamente',
    progress: 0,
  },
